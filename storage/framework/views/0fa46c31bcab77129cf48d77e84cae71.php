      ...
      <div class="card text-center position-relative mb-3 card-hover-effect">
          ...
          <div class="dropdown position-absolute top-0 end-0 m-2 dropend">
            ...
            <ul class="dropdown-menu shadow">
              <li><a class="dropdown-item open-folder" href="#" data-folder-id="<?php echo e($i); ?>">Open</a></li>
              <li><a class="dropdown-item rename-folder" href="#" data-folder-id="<?php echo e($i); ?>">Rename</a></li>
              <li><a class="dropdown-item text-danger delete-folder" href="#" data-folder-id="<?php echo e($i); ?>">Delete</a></li>
            </ul>
          </div>
          ...
          <div class="card-body">
            <a href="#" class="folder-link">
                <img src="<?php echo e(asset('assets/img/folder-icon.png')); ?>" alt="Folder Icon" 
                     class="img-fluid mb-2" style="width: 110px;">
                <h6 class="card-title mb-0">Folder <?php echo e($i + 1); ?></h6>
            </a>
        </div>
      </div>
    </div>
...
<?php /**PATH /var/www/brainshare_ai/resources/views/dashboard2.blade.php ENDPATH**/ ?>