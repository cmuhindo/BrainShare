...
<head>
    ...
    <title><?php echo e($course->course_title); ?></title>
...
<body>
    ...
    <div class="main-content">
        <div class="course-header">
            ...
            <h1><?php echo e($courseContent['courseTitle']); ?></h1>
            <p><?php echo e($courseContent['courseDescription']); ?></p>
            <span class="badge bg-secondary"><?php echo e($courseContent['class']); ?></span>
        </div>

        <div class="course-section">
            <?php $__currentLoopData = $courseContent['topics']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $topic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="mb-4">
                    <div class="topic-title"><?php echo e($topic['title']); ?></div>
                    <ul>
                        <?php $__currentLoopData = $topic['subtopics']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subtopic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="subtopic">
                                <span><?php echo e($subtopic); ?></span>
                                <?php if(in_array($subtopic, $subtopicsWithContent)): ?>
                                    <button class="btn btn-success btn-animation" data-subtopic="<?php echo e($subtopic); ?>" onclick="viewContent('<?php echo e($subtopic); ?>', <?php echo e($course->id); ?>)">View Content</button>
                                <?php else: ?>
                                    <button class="btn btn-primary btn-animation" data-subtopic="<?php echo e($subtopic); ?>" onclick="generateContent('<?php echo e($subtopic); ?>', this, <?php echo e($course->id); ?>)">Generate Content</button>
                                <?php endif; ?>
                            </li>
                    ...
                    <div class="generate-quiz-container">
                        <button class="btn btn-animation" onclick="generateQuiz('<?php echo e($topic['title']); ?>', this, <?php echo e($course->id); ?>)">Generate Topical Quiz</button>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            const subtopicsWithContent = <?php echo json_encode($subtopicsWithContent, 15, 512) ?>;
            ...
            subtopicsWithContent.forEach(subtopic => {
                ...
                if (button) {
                    ...
                    button.onclick = function () {
                        viewContent(subtopic, <?php echo e($course->id); ?>);
                    };
                }
            });
        });
...
<?php /**PATH /var/www/brainshare_ai/resources/views/generated-course.blade.php ENDPATH**/ ?>