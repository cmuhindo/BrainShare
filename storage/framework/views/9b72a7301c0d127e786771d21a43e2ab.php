...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('studentlogin')); ?>">Login</a></li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('studentregister')); ?>">Register</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <div class="container mt-5 mb-5 main-content">
        <div class="form-container">
            <form method="POST" action="<?php echo e(route('studentlogin')); ?>">
            ...
            <div class="form-group">
                ...
                <?php $__errorArgs = ['username_or_email'];
...
<?php /**PATH /var/www/brainshare_ai/resources/views/auth/login.blade.php ENDPATH**/ ?>